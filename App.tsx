        ...
        {active === "Dashboard" && (
          <div>
            ...
            <section className="actions">
              <div className="action-card" onClick={() => setActive("Wallet")}>💸 Send</div>
              <div className="action-card" onClick={() => setActive("Wallet")}>📥 Request</div>
              <div className="action-card" onClick={() => setActive("Wallet")}>📲 Deposit</div>
              <div className="action-card" onClick={() => setActive("Wallet")}>🏧 Withdraw</div>
            </section>
